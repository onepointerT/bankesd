...
char* leftrotatemuliple( const char* word, const unsigned int rotate_mulitplicator, const unsigned short wordbit, const unsigned short bitlength, const unsigned int bits_selected ) {
